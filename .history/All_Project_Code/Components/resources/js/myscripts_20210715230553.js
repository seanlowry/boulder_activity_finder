...
function start_download(){
  ...
  //create <a> for event.ics to be download
...
var icsFile = null;
/*
  ics file can automatically switch time for users in different region
  default region: Shanghai
  
  remind users event before 10 mins
*/
