...
app.post('/public_post',function(req, res){
    ...
    // console.log(ids)
        ...
        //"INSERT INTO comments(post_id, author_id, body)VALUES(6,4,'second comment');"
        var query1 = "INSERT INTO comments(post_id, author_id, body)VALUES("+parseInt(temp_arr[0])+","+parseInt(temp_arr[1])+"," + ids+",'"+comment+"');"
        console.log(query1)
