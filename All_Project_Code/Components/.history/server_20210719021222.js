...
app.post('/new_post/annou', function(req,res){
    ...
    var new_summary = req.body.new_summary
    var query1 = "INSERT INTO posts(author_id,title, summary, desc)VALUES("+parseInt(temp_arr[0])+","+parseInt(temp_arr[1])+"," + id+",'"+comment+"');"

    var desc = req.body.new_desc
    var query = "INSERT TABLE post"
    res.render('pages/post',{
        title: "post",
        alert_msg: "",
    })
