...
/*
  calendar can automatically switch to Boulde time for users in different regions with TZID being set
...
function createICSfile(id){
    ...
    "BEGIN:VEVENT\n" + 
     ...
     temp_date[2] + retMonth(temp_date[0]) + temp_date[1] + "T" + "080000" +
     "\n" +
